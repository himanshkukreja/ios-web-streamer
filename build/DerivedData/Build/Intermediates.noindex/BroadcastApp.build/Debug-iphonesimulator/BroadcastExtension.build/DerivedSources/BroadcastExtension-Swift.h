...
#ifndef BROADCASTEXTENSION_SWIFT_H
#define BROADCASTEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BroadcastExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18BroadcastExtension13SampleHandler")
...
SWIFT_CLASS("_TtC18BroadcastExtension15WebSocketClient")
...
@interface WebSocketClient (SWIFT_EXTENSION(BroadcastExtension)) <NSURLSessionWebSocketDelegate>
